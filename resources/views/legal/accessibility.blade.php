...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-4xl">
    ...
    <div class="space-y-6 text-gray-700">
        ...
        <h2 class="text-2xl font-bold text-gray-900 pt-4">1. Conformance Status</h2>
        <p>
        ...
        <h2 class="2xl font-bold text-gray-900 pt-4">2. Technical Specifications (Bogus Content)</h2>
        <p>
        ...
        <h2 class="2xl font-bold text-gray-900 pt-4">3. Feedback</h2>
        <p>
