    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12 flex justify-center items-center">
        ...
        <div class="w-full max-w-md bg-white dark:bg-gray-800 p-8 rounded-xl shadow-2xl border border-gray-100 dark:border-gray-700 transition-colors duration-300">
            ...
            <p class="text-center text-gray-600 dark:text-gray-400 mb-8">
                Welcome back! Log in to access your dashboard and shopping cart.
            </p>
            ...
            <form action="{{ route('login.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    >
                    @error('password')
                         <!-- We don't usually show password errors for security -->
                    @enderror
                </div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <input id="remember-me" name="remember-me" type="checkbox"
                            class="h-4 w-4 text-primary border-gray-300 dark:border-gray-600 rounded focus:ring-primary dark:bg-gray-700"
                        >
                    ...
                    <div class="text-sm">
                        <a href="#" class="font-medium text-primary hover:text-green-700 transition duration-150">
            ...
            <p class="mt-8 text-center text-sm text-gray-600 dark:text-gray-400">
                ...
                <a href="{{ route('register') }}" class="font-medium text-primary hover:text-green-700 transition duration-150">
                    Register here
                </a>
            </p>
        </div>
