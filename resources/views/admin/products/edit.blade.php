...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="max-w-3xl mx-auto bg-white dark:bg-gray-800 p-8 rounded-xl shadow-2xl border border-gray-100 dark:border-gray-700">
        <div class="flex items-center justify-between border-b pb-4 mb-6 dark:border-gray-700">
            ...
            <a href="{{ route('admin.products.index') }}" class="text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-primary transition duration-150 flex items-center">
                &larr; Back to Product List
            </a>
        </div>

        @if ($errors->any())
            <div class="bg-red-100 dark:bg-red-900 border border-red-400 dark:border-red-500 text-red-700 dark:text-red-300 px-4 py-3 rounded relative mb-6" role="alert">
        ...
        <form action="{{ route('admin.products.update', $product) }}" method="POST" class="space-y-6" enctype="multipart/form-data">
            @csrf
            @method('PUT') {{-- Required for Laravel's PUT route method spoofing --}}

            <!-- Product Image Display -->
            <div class="mb-6 border-b pb-4 dark:border-gray-700">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">Current Image</h3>
                <img src="{{ asset('storage/' . $product->image_url) }}" alt="{{ $product->name }}" class="w-32 h-32 object-cover rounded-lg shadow-md">
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-2">Current path: <span class="text-gray-700 dark:text-gray-300 truncate inline-block max-w-full">{{ $product->image_url }}</span></p>
            </div>

            <!-- Image Upload Field (Optional Update) -->
            <div>
                <label for="image" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Replace Image (Optional)</label>
            ...
            <div>
                ...
                <input id="name" name="name" type="text" required
                    class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm placeholder-gray-400 dark:bg-gray-700 dark:text-white focus:ring-primary focus:border-primary transition duration-150 @error('name') border-red-500 @enderror"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input id="price" name="price" type="number" step="0.01" min="0.01" required
                        class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm placeholder-gray-400 dark:bg-gray-700 dark:text-white focus:ring-primary focus:border-primary transition duration-150 @error('price') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <input id="sale_price" name="sale_price" type="number" step="0.01" min="0.01"
                        class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm placeholder-gray-400 dark:bg-gray-700 dark:text-white focus:ring-primary focus:border-primary transition duration-150 @error('sale_price') border-red-500 @enderror"
            ...
            <div>
                ...
                <input id="stock" name="stock" type="number" min="0" required
                    class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm placeholder-gray-400 dark:bg-gray-700 dark:text-white focus:ring-primary focus:border-primary transition duration-150 @error('stock') border-red-500 @enderror"
            ...
            <!-- Category (UPDATED FOR CLOTHING STORE) -->
            <div>
